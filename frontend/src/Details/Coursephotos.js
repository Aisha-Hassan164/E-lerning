...
<h1 className=" text-xl  lg:text-5xl"> Adobe Photoshop </h1>
<p className="mb-3 mt-3  text-lg  lg:text-xl">Learn The most valuable skill in web development from scratch Learn Adobe photo shop.</p>
