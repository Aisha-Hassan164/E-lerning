...
<h1 className=" text-xl  lg:text-5xl"> Adobe Illustrator </h1>
<p className="mb-3 mt-3  text-lg  lg:text-xl">Learn The most valuable skill in web development from scratch Learn Adobe Illustorator.</p>
...
<p className=" text-lg lg:text-xl mt-10" >We’re committed to changing the future of learning for the better 
  ...
  <button className="w-40 bg-green-400 text-black p-1 rounded-lg mt-5"> <Link to="/Signin"> Enroll Course </Link></button>
...
export default Courseillustrator;
