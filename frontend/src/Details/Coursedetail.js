...
<h1 className=" text-xl  lg:text-5xl"> React Master Class with Redux, Hooks, Firebase, Tailwind css, </h1>
...
<p className=" text-lg lg:text-xl mt-10" >We’re committed to changing the future of learning for the better 
  ...
  <button className="w-40 bg-green-400 text-black p-1 rounded-lg mt-5">Enroll Course</button>
