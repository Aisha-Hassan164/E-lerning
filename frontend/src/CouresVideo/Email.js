...
<h1 className="mb-5 text-xl">Send Us Massage</h1>
    <form ref={form} onSubmit={sendEmail}>
      ...
      <input type="text" name="user_name" className="w-72 p-2 lg:p-2 lg:w-96 lg:w-96 bg-transparent border border-gray-400 rounded-md  " /><br/>
      <label  className="text-xl">Email</label><br/>
      <input type="email" name="user_email" className="w-72 p-2 lg:p-2 lg:w-96 lg:w-96 bg-transparent border border-gray-400 rounded-md   "/><br/>
      <label  className="text-xl">Message</label><br/>
      <textarea name="message"  className="mt-3 bg-transparent border border-gray-400 rounded-md w-72 h-32 lg:w-96 h-20"/><br/>
     <Link to="/Email"><input type="submit" value="Send"   className="mt-3 bg-emerald-400 text-black text-lg p-2 w-72 lg:ml-10 rounded-md hover:translate-x-2 duration-100 hover:bg-slate-600 hover:text-white" /></Link> <br/>
    </form>
</div>
    </div>
    </div>
